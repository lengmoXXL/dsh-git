...
一个 DSH 插件：给右侧栏加一个 **Git log** 标签页——工作区改动在上、最近提交在下——点一条改动、或点某个提交里的某个文件，就在旁边新开一个只读、带高亮、双栏对齐的 diff 标签页。

[English](README.md) | 中文

![Git log 标签页：上面是改动，下面是提交。点提交展开它改动的文件，点文件打开它的 diff。](docs/screenshots/zh/01-log.png)
